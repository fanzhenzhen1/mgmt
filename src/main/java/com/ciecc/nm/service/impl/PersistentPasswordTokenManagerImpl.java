...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.ciecc.nm.service.impl.PasswordTokenManager#generateRecoveryToken(com.ciecc.nm.model.User)
     */
    @Override
    ...
    /**
     * @see com.ciecc.nm.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.ciecc.nm.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.ciecc.nm.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
